...
if __name__ == '__main__':
    ...
    parser.add_argument('--MiniImagenet_batch_size', type=int, default=3,
        help='Number of tasks in a mini-batch of tasks for MiniImagenet (default: 3).')
    parser.add_argument('--CIFARFS_batch_size', type=int, default=3,
        help='Number of tasks in a mini-batch of tasks for CIFARFS (default: 3).')
    parser.add_argument('--CUB_batch_size', type=int, default=3,
        help='Number of tasks in a mini-batch of tasks for CUB (default: 3).')
    parser.add_argument('--Omniglot_batch_size', type=int, default=3,
        help='Number of tasks in a mini-batch of tasks for Omniglot (default: 3).')
    parser.add_argument('--Aircraft_batch_size', type=int, default=3,
        help='Number of tasks in a mini-batch of tasks for Aircraft (default: 3).')
